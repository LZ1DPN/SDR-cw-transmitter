...
// Si5351 SDR CW Transmitter support from LZ1DPN 12-September-2017 
//
...
//  debug("Radiono starting - Version: SDRtx");
...
//  unsigned long a = ifFreq - (displayFreq + adjFreq);
  unsigned long a = (displayFreq + adjFreq);
  vfo->setFrequency(a);  
  displayDirty = true;  
}
